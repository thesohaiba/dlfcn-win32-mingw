# POSIX dlfcn implementation for Windows (Win32) with MinGW.

Used sources from [dlfcn-win32](https://github.com/dlfcn-win32/dlfcn-win32) repo and setupped compile MinGW static (`lib\[...].a`) \& dynamic (`\[...].dll`) libraries.
